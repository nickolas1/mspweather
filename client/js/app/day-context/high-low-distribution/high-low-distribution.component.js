...
export class HighLowDistributionComponent {
  ...
  renderPlot() {
    ...
    if (this.parentNativeElement !== null && this.observation.date && this.historical.highs) {
      ...
      // const highLine = [
      //   [+this.observation.high, 0],
      //   [+this.observation.high, distH[bisector(distH, +this.observation.high)][1] + rangePad / 2]
      // ];
      // const lowLine = [
      //   [+this.observation.low, 0],
      //   [+this.observation.low, distL[bisector(distL, +this.observation.low)][1] + rangePad / 2]
      // ];
